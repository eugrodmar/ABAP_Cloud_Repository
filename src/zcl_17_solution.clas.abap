CLASS zcl_17_solution DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_17_SOLUTION IMPLEMENTATION.
...
*        DATA carrier_1 TYPE REF TO lcl_carrier.
*        IF carrier_1 IS BOUND.
*          out->write( 'Objeto declarado, NO instanciado' ).
*        ENDIF.
*
*        carrier_1 = NEW lcl_carrier(  i_carrier_id = c_carrier_id ).
*        IF carrier_1 IS BOUND.
*          out->write( 'Objeto declarado e instanciado' ).
*        ENDIF.
*        EXIT.
