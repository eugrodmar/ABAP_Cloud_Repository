CLASS zcl_tenis_consola_17 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS zcl_tenis_consola_17 IMPLEMENTATION.



  METHOD if_oo_adt_classrun~main.

    DATA lo_torneo    TYPE REF TO zcl_torneo_tenis_17.
    DATA lo_j1        TYPE REF TO zcl_jugador_profesional_17.
    DATA lo_j2        TYPE REF TO zcl_jugador_profesional_17.
    DATA lo_j3        TYPE REF TO zcl_jugador_amateur_17.
    DATA lo_j4        TYPE REF TO zcl_jugador_amateur_17.
    DATA lo_lider     TYPE REF TO zcl_jugador_base_17.
    ...
    TRY.
        lo_torneo = NEW zcl_torneo_tenis_17( iv_nombre_torneo = 'Roland Garros 2026' ).

        lo_j1 = NEW zcl_jugador_profesional_17(
                  iv_nombre = 'Alcaraz'
                  iv_pais   = 'ESP'
                  iv_ranking_inicial = 1 ).

        lo_j2 = NEW zcl_jugador_profesional_17(
                  iv_nombre = 'Sinner'
                  iv_pais   = 'ITA'
                  iv_ranking_inicial = 2 ).

        lo_j3 = NEW zcl_jugador_amateur_17(
                  iv_nombre = 'Garcia'
                  iv_pais   = 'ESP'
                  iv_club   = 'Club Sevilla' ).

        lo_j4 = NEW zcl_jugador_amateur_17(
                  iv_nombre = 'Lopez'
                  iv_pais   = 'ESP'
                  iv_club   = 'Club Huelva' ).
