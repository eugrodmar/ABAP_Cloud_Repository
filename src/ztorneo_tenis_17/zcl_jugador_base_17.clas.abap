CLASS zcl_jugador_base_17 DEFINITION
  PUBLIC
  ABSTRACT
  CREATE PUBLIC.

  PUBLIC SECTION.
    INTERFACES zif_puntuable_17.
    INTERFACES zif_clasificable_17.
...
CLASS zcl_jugador_base_17 IMPLEMENTATION.
...
METHOD registrar_victoria.
  ...
  METHOD zif_clasificable_17~esta_clasificado.
    IF mv_victorias > 5.
      rv_result = abap_true.
    ELSE.
  ...
  METHOD zif_clasificable_17~get_posicion_ranking.
