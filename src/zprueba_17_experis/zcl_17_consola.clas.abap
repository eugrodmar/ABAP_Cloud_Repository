CLASS zcl_17_consola DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_17_consola IMPLEMENTATION.
...
*    APPEND ls_vuelo TO lt_vuelos.
*
*    INSERT zvuelos_17 FROM TABLE @lt_vuelos.
*
*    IF sy-subrc = 0.
...
*    LOOP AT lt_clase INTO DATA(ls_clase).
...
*
*DATA lt_reservas TYPE TABLE OF zreservas_17.
*DATA ls_reserva  TYPE zreservas_17.
*
...
*APPEND ls_reserva TO lt_reservas.
*
*MODIFY zreservas_17 FROM TABLE @lt_reservas.
*
*
*
*IF sy-subrc = 0.
...
*UPDATE zreservas_17
*SET precio = 480 WHERE id_reserva = 3.
*
...
*
*UPDATE zreservas_17
*SET estado = 'C' WHERE id_reserva = 4.
*
